    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                ...
                // Get categories to find the 'food' category
                const categoriesRes = await getCategories(merchantId);
                const categories = categoriesRes.data?.data || categoriesRes.data || [];
                console.log('Categories:', categories);

                // Try different possible food category names
                ...
                if (!foodCategory) {
                    console.log('No food category found. Create a category named "food" in the admin.');
                    setLoading(false);
                    return;
                }

                // Get products for food category
                const categoryId = foodCategory.id || foodCategory._id;
                ...
                console.log('Food products:', allProducts);
