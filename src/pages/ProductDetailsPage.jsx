...
const ProductDetailsPage = () => {
    ...
    // Use product images from API or fallback
    ...
    // Use product variations or fallback sizes
    const sizes = product?.has_variation
        ? ['XS', 'S', 'M', 'L', 'XL', 'XXL']
        : ['XS', 'S', 'M', 'L', 'XL', 'XXL', 'XLP'];

    // Build color variants from product variations or use single default
    ...
    const handleAddToCart = () => {
        const user = localStorage.getItem('walmart_user');
        if (!user) {
            navigate('/signin');
            return;
        }
    ...
    const productTitle = product?.title || 'Wonder Nation Girls Trend Crochet Top, sizes 4-18 & Plus';
                    ...
                    <div className="lg:w-[25%]">
                        <div className="sticky top-20">
                            <div className="bg-gray-50 rounded-lg p-4 mb-4">
                                ...
                                <div className="flex items-center gap-1 mb-3">
                                    ...
                                    <span className="text-xs">
                                        {product?.has_refund_policy ? 'Free 90-day returns' : 'No returns'}
                                    </span>
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full bg-blue-600 text-white py-2 rounded-full font-semibold text-sm hover:bg-blue-700 transition-colors mb-3"
                                >
                                    Add to cart
                                </button>

                                {/* Login notice */}
                                {!localStorage.getItem('walmart_user') && (
                                    ...
                                    <div className="flex gap-2 w-full max-w-[250px]">
                                        <div className={`flex-1 text-center border p-2 rounded ${product?.has_shipment ? 'bg-white border-gray-700' : 'bg-gray-100 opacity-50'}`}>
                                            ...
                                            <p className="text-[10px] text-gray-500">
                                                {product?.has_shipment ? 'Available' : 'Not available'}
                                            </p>
                                        </div>
                                        <div className="flex-1 text-center p-2 border rounded bg-gray-100 opacity-50">
                                            <FaMapMarkerAlt className="mx-auto text-gray-400 text-sm" />
                            ...
                            <div className="shadow rounded-lg p-3">
                                ...
                                <div className="flex gap-3 mb-3">
                                    <img src="https://i5.walmartimages.com/seo/Justice-Girls-Cinch-Front-Top-Sizes-XS-XLP_7c108f42-be39-4258-af5e-cbfd26cceaf2.5e4635521cf12298da422ef3784ad71f.jpeg?odnHeight=2000&odnWidth=2000&odnBg=FFFFFF" alt="Sponsored" className="w-24 h-24 object-cover rounded" />
                                    <div>
                                        <p className="text-md font-bold">$12.00</p>
                                        <p className="text-sm text-gray-600">Justice Girls Cinch Front Top, Sizes XS - XLP</p>
                                        <div className="flex items-center gap-1 mt-1">
